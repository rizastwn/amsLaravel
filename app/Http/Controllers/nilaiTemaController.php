...
class nilaiTemaController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $tujuanTema = tema ::where([
            ['tema',request('tema')]
        ])->first();
        return view('tema.show')->with([
            'siswa' => $siswa, 
            'nilai' => $nilai, 
            'nilaiSikap' => $nilaiSikap,
            'tema'=>$tema,
            'tujuanTema' => $tujuanTema,
            ]);
    ...
    public function nilaiSubtema(Request $request, $id)
    {
        ...
        if (request()->has('tema')) {
            ...
            $nilaiPengetahuan = nilaiSubtema::where([
                ['idKelas', $kelas->id],
                ['tema', $request->input('tema')],
                ['jenis', 'pengetahuan'],
                ['subtema', $request->input('subtema')],
            ])->get();
            $nilaiKetrampilan = nilaiSubtema::where([
                ['idKelas', $kelas->id],
                ['tema', $request->input('tema')],
                ['jenis', 'ketrampilan'],
                ['subtema', $request->input('subtema')],
    ...
    public function showSubtema($id)
    {
        ...
        $subtema = subtema::where([
            ...
            ['mataPelajaran',$nilaiSubtema->mataPelajaran]
        ])->first();
        $tema = tema::where([
            ['tema', $nilaiSubtema->tema],
